...
type S2C struct {
	...
	CnQotRight            *int32  `protobuf:"varint,6,opt,name=cnQotRight" json:"cnQotRight,omitempty"`                       //A股行情权限, QotRight
	...
	UsFutureQotRight      *int32  `protobuf:"varint,16,opt,name=usFutureQotRight" json:"usFutureQotRight,omitempty"`       //美股期货行情权限, Qot_Common.QotRight
	...
	UserAttribution       *int32  `protobuf:"varint,19,opt,name=userAttribution" json:"userAttribution,omitempty"`         //用户注册归属地
...
var file_GetUserInfo_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x05, 0x52, 0x04, 0x66, 0x6c, 0x61, 0x67, 0x22, 0xb1, 0x06, 0x0a, 0x03, 0x53, 0x32,
	...
	0x75, 0x73, 0x4f, 0x74, 0x63, 0x51, 0x6f, 0x74, 0x52, 0x69, 0x67, 0x68, 0x74, 0x22, 0x2d, 0x0a,
	...
	0x42, 0x48, 0x0a, 0x13, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x75, 0x74, 0x75, 0x2e, 0x6f, 0x70, 0x65,
	0x6e, 0x61, 0x70, 0x69, 0x2e, 0x70, 0x62, 0x5a, 0x31, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	0x63, 0x6f, 0x6d, 0x2f, 0x67, 0x61, 0x6e, 0x64, 0x61, 0x6c, 0x66, 0x31, 0x30, 0x32, 0x34, 0x2f,
	0x67, 0x6f, 0x2d, 0x66, 0x75, 0x74, 0x75, 0x2d, 0x61, 0x70, 0x69, 0x2f, 0x70, 0x62, 0x2f, 0x67,
	0x65, 0x74, 0x75, 0x73, 0x65, 0x72, 0x69, 0x6e, 0x66, 0x6f,
}
...
var file_GetUserInfo_proto_goTypes = []interface{}{
...
func file_GetUserInfo_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_GetUserInfo_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*C2S); i {
			case 0:
				return &v.state
			case 1:
		...
		file_GetUserInfo_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*S2C); i {
			case 0:
				return &v.state
			case 1:
		...
		file_GetUserInfo_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_GetUserInfo_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
